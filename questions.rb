...
def separate_array_into_even_and_odd_numbers(array)
	# a1 = array.map{ |n| n if n % 2 == 1 }.compact
	# a2 = array.map{ |n| n if n % 2 == 0 }.compact
	# array = [a2] + [a1]
	array.partition{|num| num % 2 == 0}
end
...
def number_of_elements_that_are_palindromes(array)
	array.map.count {|word| word if word == word.reverse}
end
...
def average_of_array(array)
	(array.inject{|sum, el| sum + el}.to_f / array.size).ceil
end
